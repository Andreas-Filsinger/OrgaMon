...
OutputDir=..\..\CargoBay
OutputBaseFilename=Setup-Oc-1248
AppVersion=1248
ChangesAssociations=yes
Compression=lzma/max
WizardImageFile=compiler:WIZMODERNIMAGE-IS.BMP
WizardSmallImageFile=compiler:WIZMODERNSMALLIMAGE-IS.BMP
; VersionInfoVersion=1.248
...
begin
  ...
  myOpenMenu   := 'xls-Konvertieren mit Oc 1.248'   //the menu item that will be displayed when you right-click on a file with your extension
  ...
  myOpenMenu   := 'txt-Konvertieren mit Oc 1.248'   //the menu item that will be displayed when you right-click on a file with your extension
  myExeName    := 'Oc.exe'          //the executable that is associated with the extension (assumes it is in {app})
  ...
  myOpenMenu   := 'csv-Konvertieren mit Oc 1.248'   //the menu item that will be displayed when you right-click on a file with your extension
  myExeName    := 'Oc.exe'          //the executable that is associated with the extension (assumes it is in {app})
  ...
  myOpenMenu   := 'xml-Konvertieren mit Oc 1.248'   //the menu item that will be displayed when you right-click on a file with your extension
  myExeName    := 'Oc.exe'          //the executable that is associated with the extension (assumes it is in {app})
  ...
  myOpenMenu   := 'xml-Validierung mit Oc 1.248'   //the menu item that will be displayed when you right-click on a file with your extension
  myExeName    := 'Oc.exe'          //the executable that is associated with the extension (assumes it is in {app})
