...
OutputDir=..\..\CargoBay
OutputBaseFilename=Setup-Oc-1233
AppVersion=1233
ChangesAssociations=yes
Compression=lzma/max
WizardImageFile=compiler:WIZMODERNIMAGE-IS.BMP
WizardSmallImageFile=compiler:WIZMODERNSMALLIMAGE-IS.BMP
; VersionInfoVersion=1.233
...
begin
  ...
  myOpenMenu   := 'xls-Konvertieren mit Oc 1.233'   //the menu item that will be displayed when you right-click on a file with your extension
  ...
  myOpenMenu   := 'txt-Konvertieren mit Oc 1.233'   //the menu item that will be displayed when you right-click on a file with your extension
  myExeName    := 'Oc.exe'          //the executable that is associated with the extension (assumes it is in {app})
  ...
  myOpenMenu   := 'csv-Konvertieren mit Oc 1.233'   //the menu item that will be displayed when you right-click on a file with your extension
  myExeName    := 'Oc.exe'          //the executable that is associated with the extension (assumes it is in {app})
  ...
  myOpenMenu   := 'xml-Konvertieren mit Oc 1.233'   //the menu item that will be displayed when you right-click on a file with your extension
  myExeName    := 'Oc.exe'          //the executable that is associated with the extension (assumes it is in {app})
  ...
  myOpenMenu   := 'xml-Validierung mit Oc 1.233'   //the menu item that will be displayed when you right-click on a file with your extension
  myExeName    := 'Oc.exe'          //the executable that is associated with the extension (assumes it is in {app})
  ...
  myOpenMenu   := 'tab-Konvertieren mit Oc 1.233'   //the menu item that will be displayed when you right-click on a file with your extension
  myExeName    := 'Oc.exe'          //the executable that is associated with the extension (assumes it is in {app})
