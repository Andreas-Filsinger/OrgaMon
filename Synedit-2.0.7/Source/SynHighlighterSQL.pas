...
//---Interbase 6----------------------------------------------------------------
  // functions
  Interbase6_Function: UnicodeString = 'AVG,CAST,COUNT,GEN_ID,MAX,MIN,SUM,UPPER,'+
'CURRENT_DATE,CURRENT_TIME,CURRENT_TIMESTAMP,WEEKDAY,YEAR,YEARDAY,RDB_DATABASE,'+
'MONTH,HOUR' ;

  // keywords
  Interbase6_Key: UnicodeString = 'ACTIVE,ADD,AFTER,ALL,ALTER,AND,ANY,AS,ASC,' +
    ...
    'CONTAINING,CONTINUE,CREATE,CURRENT,CURSOR,DATABASE,DAY,DB_KEY,DEBUG,DEC,DECLARE,DEFAULT,' +
    ...
    'EXECUTE,EXISTS,EXIT,EXTERN,EXTERNAL,EXTRACT,FETCH,FILE,FILTER,FIRST,FOR,' +
    'FOREIGN,FOUND,FROM,FULL,FUNCTION,GDSCODE,GENERATOR,GLOBAL,GOTO,GRANT,' +
    'GROUP,GROUP_COMMIT_WAIT,GROUP_COMMIT_WAIT_TIME,HAVING,HELP,IF,' +
    ...
    'MODULE_NAME,NAMES,NATIONAL,NATURAL,NCHAR,NO,NOAUTO,NOT,NULL,' +
  ...
  // types
  Interbase6_DataType: UnicodeString =
...
begin
  ...
  case fDialect of
    ...
    sqlInterbase6:
      case TtkTokenKind(TokenKind) of
        tkDatatype: Result := Interbase6_DataType;
        tkFunction: Result := Interbase6_Function;
        tkKey: Result := Interbase6_Key;
      end;
    sqlMSSQL7:
      case TtkTokenKind(TokenKind) of
