...
{ public $items = array();
  ...
  public function buildPageIndex($page_index_range = 0)
  { //$template_index_option_disabled = ($template_index_option_disabled == "") ? $template_index_option : $template_index_option_disabled;
    ...
    for($i = $page_start; $i < $page_start + $range; $i++)
	{ //$this->page_index[] = new tpages_index_option($i,($i != $this->page) ? $template_index_option : $template_index_option_disabled);
