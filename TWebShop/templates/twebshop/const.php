...
define("__TEMPLATE_PROJECTNAME","TemplateTWebShop");
...
"<tr><td style=\"padding-left:5px;\"><a href=\"./viewer.php?file=~ENCRYPTED_DOCUMENT~\" target=\"_blank\">~RECHNUNGSNUMMER~ (~NUMBER~)</a></td><td style=\"text-align:right;\">~TOPAY~</td><td style=\"text-align:right;\">~DATE~</td><td style=\"text-align:right; padding-right:5px;\">~TIME~</td></tr>" . CRLF
);
