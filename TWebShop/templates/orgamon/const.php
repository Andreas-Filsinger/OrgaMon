...
define("__TEMPLATE_PROJECTNAME","TemplateOrgaMon");
...
<td colspan=\"2\" style=\"padding:0px; height:19px; wi2dth:150px; padding-right:7px; border:0px; background-color:#D9D9D9; font-size:13px; text-align:right;\"><b>" . WORD_ORDER_NO . " ~NUMERO~</b></td>
...
"<a href=\"" . __INDEX . "?site=cart&action=add_to_cart&aid=~AID~&id=~RID~\">" . image_tag(__TEMPLATE_IMAGES_PATH."option_add_to_cart.png",SENTENCE_ADD_TO_CART,"vertical-align:middle; margin-right:10px;") . "</a>"
);
...
// TEMPLATE FÜR OPTION INDEXABBILDUNG IM EINKAUFSWAGEN
...
"<tr><td style=\"padding-left:5px;\"><a href=\"./viewer.php?file=~ENCRYPTED_DOCUMENT~\" target=\"_blank\">~RECHNUNGSNUMMER~</a></td><td style=\"text-align:right;\"><a href=\"./viewer.php?file=~ENCRYPTED_TIMECARD~\" target=\"_blank\">~NUMBER~</a></td><td style=\"text-align:right;\">~TOPAY~</td><td style=\"text-align:right;\">~DATE~</td><td style=\"text-align:right; padding-right:5px;\">~TIME~</td></tr>" . CRLF
);
...
define("__TEMPLATE_REVISION","1.005");
