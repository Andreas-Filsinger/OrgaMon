...
var
  ...
  cFormFieldInfo: array[0..1024] of AnsiChar;
  pFormFieldInfo: PAnsiChar;
  Buffer: PChar;
  iSize: Int64;
begin
  iSize := FileData.Size;
// Malikyar -- Removed the Content_length parameter since the web buffer did not contain it.
{
  ...
  pFormFieldInfo := StrPCopy(cFormFieldInfo,sFormFieldInfo);

  Write(pFormFieldInfo^, Length(sFormFieldInfo));
