...
type
      ...
      errorSAXFunc = procedure  (ctx: Pointer; const msg: wasPChar); cdecl varargs;
      ...
      fatalErrorSAXFunc = procedure  (ctx: Pointer; const msg: wasPChar); cdecl varargs;
        fatalErrorSAXFuncPtr = ^fatalErrorSAXFunc;

      ftpDataCallback = procedure  (userData: Pointer; const data: wasPChar; len: Longint); cdecl;
        ftpDataCallbackPtr = ^ftpDataCallback;

      ftpListCallback = procedure  (userData: Pointer; const filename: wasPChar; const attrib: wasPChar; const owner: wasPChar; const group: wasPChar; size: Cardinal; links: Longint; year: Longint; const month: wasPChar; day: Longint; hour: Longint; minute: Longint); cdecl;
      ...
      warningSAXFunc = procedure  (ctx: Pointer; const msg: wasPChar); cdecl varargs;
      ...
      xmlExternalEntityLoader = function  (const URL: wasPChar; const ID: wasPChar; context: xmlParserCtxtPtr) : xmlParserInputPtr; cdecl;
        xmlExternalEntityLoaderPtr = ^xmlExternalEntityLoader;

      xmlFreeFunc = procedure  (mem: Pointer); cdecl;
        xmlFreeFuncPtr = ^xmlFreeFunc;

      xmlGenericErrorFunc = procedure  (ctx: Pointer; const msg: wasPChar); cdecl varargs;
      ...
      xmlInputMatchCallback = function  (filename: wasPChar) : Longint; cdecl;
        xmlInputMatchCallbackPtr = ^xmlInputMatchCallback;

      xmlInputOpenCallback = function  (filename: wasPChar) : Pointer; cdecl;
        xmlInputOpenCallbackPtr = ^xmlInputOpenCallback;

      xmlInputReadCallback = function  (context: Pointer; buffer: wasPChar; len: Longint) : Longint; cdecl;
      ...
      xmlOutputBufferCreateFilenameFunc = function  (const URI: wasPChar; encoder: xmlCharEncodingHandlerPtr; compression: Longint) : xmlOutputBufferPtr; cdecl;
      ...
      xmlOutputMatchCallback = function  (filename: wasPChar) : Longint; cdecl;
        xmlOutputMatchCallbackPtr = ^xmlOutputMatchCallback;

      xmlOutputOpenCallback = function  (filename: wasPChar) : Pointer; cdecl;
        xmlOutputOpenCallbackPtr = ^xmlOutputOpenCallback;

      xmlOutputWriteCallback = function  (context: Pointer; const buffer: wasPChar; len: Longint) : Longint; cdecl;
        xmlOutputWriteCallbackPtr = ^xmlOutputWriteCallback;

      xmlParserInputBufferCreateFilenameFunc = function  (const URI: wasPChar; enc: xmlCharEncoding) : xmlParserInputBufferPtr; cdecl;
      ...
      xmlRelaxNGValidityErrorFunc = procedure  (ctx: Pointer; const msg: wasPChar); cdecl varargs;
        xmlRelaxNGValidityErrorFuncPtr = ^xmlRelaxNGValidityErrorFunc;

      xmlRelaxNGValidityWarningFunc = procedure  (ctx: Pointer; const msg: wasPChar); cdecl varargs;
        xmlRelaxNGValidityWarningFuncPtr = ^xmlRelaxNGValidityWarningFunc;

      xmlSchemaValidityErrorFunc = procedure  (ctx: Pointer; const msg: wasPChar); cdecl varargs;
        xmlSchemaValidityErrorFuncPtr = ^xmlSchemaValidityErrorFunc;

      xmlSchemaValidityWarningFunc = procedure  (ctx: Pointer; const msg: wasPChar); cdecl varargs;
        xmlSchemaValidityWarningFuncPtr = ^xmlSchemaValidityWarningFunc;

      xmlSchematronValidityErrorFunc = procedure  (ctx: Pointer; const msg: wasPChar); cdecl varargs;
        xmlSchematronValidityErrorFuncPtr = ^xmlSchematronValidityErrorFunc;

      xmlSchematronValidityWarningFunc = procedure  (ctx: Pointer; const msg: wasPChar); cdecl varargs;
        xmlSchematronValidityWarningFuncPtr = ^xmlSchematronValidityWarningFunc;

      xmlShellCmd = function  (ctxt: xmlShellCtxtPtr; arg: wasPChar; node: xmlNodePtr; node2: xmlNodePtr) : Longint; cdecl;
        xmlShellCmdPtr = ^xmlShellCmd;

      xmlShellReadlineFunc = function  (prompt: wasPChar) : wasPChar; cdecl;
        xmlShellReadlineFuncPtr = ^xmlShellReadlineFunc;

      xmlStrdupFunc = function  (const str: wasPChar) : wasPChar; cdecl;
      ...
      xmlTextReaderErrorFunc = procedure  (arg: Pointer; const msg: wasPChar; severity: xmlParserSeverities; locator: xmlTextReaderLocatorPtr); cdecl;
        xmlTextReaderErrorFuncPtr = ^xmlTextReaderErrorFunc;

      xmlValidityErrorFunc = procedure  (ctx: Pointer; const msg: wasPChar); cdecl varargs;
        xmlValidityErrorFuncPtr = ^xmlValidityErrorFunc;

      xmlValidityWarningFunc = procedure  (ctx: Pointer; const msg: wasPChar); cdecl varargs;
      ...
      htmlElemDesc = record
          ...
          desc : wasPChar; { the description NRK Jan.2003
...
*}
          ...
          defaultsubelt : wasPChar; { subelement for suggested auto-repair
if necessary or NULL}
      ...
      htmlEntityDesc = record
          ...
          name : wasPChar; { The entity name}
          desc : wasPChar; { the description}
      end;
...
*}
      ...
      xmlDoc = record
          ...
          name : wasPChar; { name/filename/URI of the document}
...
* references done from that entity}
      ...
      xmlError = record
          ...
          message : wasPChar; { human-readable informative error message}
          level : xmlErrorLevel; { how consequent is the error}
          file_ : wasPChar; { the filename}
          line : Longint; { the line number if available}
          str1 : wasPChar; { extra string information}
          str2 : wasPChar; { extra string information}
          str3 : wasPChar; { extra string information}
      ...
      xmlParserInput = record
          ...
          filename : wasPChar; { The file analyzed, if any}
          directory : wasPChar; { the directory/base of the file}
...
Could we use @subtypes for this?}
      ...
      xmlURI = record
          scheme : wasPChar; { the URI scheme}
          opaque : wasPChar; { opaque part}
          authority : wasPChar; { the authority part}
          server : wasPChar; { the server part}
          user : wasPChar; { the user part}
          port : Longint; { the port number}
          path : wasPChar; { the path string}
          query : wasPChar; { the query string (deprecated - use with caution)}
          fragment : wasPChar; { the fragment identifier}
          cleanup : Longint; { parsing potentially unclean URI}
          query_raw : wasPChar; { the query string (as it appears in the URI)}
      end;
      ...
      xmlParserCtxt = record
          ...
          directory : wasPChar; { the data directory Node name stack}
...
*}
  ...
  function docbCreateFileParserCtxt (const filename: wasPChar; const encoding: wasPChar) : docbParserCtxtPtr; cdecl; external LIBXML2_SO;
  function docbCreatePushParserCtxt (sax: docbSAXHandlerPtr; user_data: Pointer; const chunk: wasPChar; size: Longint; const filename: wasPChar; enc: xmlCharEncoding) : docbParserCtxtPtr; cdecl; external LIBXML2_SO;
  ...
  function docbParseChunk (ctxt: docbParserCtxtPtr; const chunk: wasPChar; size: Longint; terminate: Longint) : Longint; cdecl; external LIBXML2_SO;
  function docbParseDoc (cur: xmlCharPtr; const encoding: wasPChar) : docbDocPtr; cdecl; external LIBXML2_SO;
  function docbParseDocument (ctxt: docbParserCtxtPtr) : Longint; cdecl; external LIBXML2_SO;
  function docbParseFile (const filename: wasPChar; const encoding: wasPChar) : docbDocPtr; cdecl; external LIBXML2_SO;
  function docbSAXParseDoc (cur: xmlCharPtr; const encoding: wasPChar; sax: docbSAXHandlerPtr; userData: Pointer) : docbDocPtr; cdecl; external LIBXML2_SO;
  function docbSAXParseFile (const filename: wasPChar; const encoding: wasPChar; sax: docbSAXHandlerPtr; userData: Pointer) : docbDocPtr; cdecl; external LIBXML2_SO;
  ...
  function htmlCreateFileParserCtxt (const filename: wasPChar; const encoding: wasPChar) : htmlParserCtxtPtr; cdecl; external LIBXML2_SO;
  function htmlCreateMemoryParserCtxt (const buffer: wasPChar; size: Longint) : htmlParserCtxtPtr; cdecl; external LIBXML2_SO;
  function htmlCreatePushParserCtxt (sax: htmlSAXHandlerPtr; user_data: Pointer; const chunk: wasPChar; size: Longint; const filename: wasPChar; enc: xmlCharEncoding) : htmlParserCtxtPtr; cdecl; external LIBXML2_SO;
  function htmlCtxtReadDoc (ctxt: htmlParserCtxtPtr; const cur: xmlCharPtr; const URL: wasPChar; const encoding: wasPChar; options: Longint) : htmlDocPtr; cdecl; external LIBXML2_SO;
  function htmlCtxtReadFd (ctxt: htmlParserCtxtPtr; fd: Longint; const URL: wasPChar; const encoding: wasPChar; options: Longint) : htmlDocPtr; cdecl; external LIBXML2_SO;
  function htmlCtxtReadFile (ctxt: htmlParserCtxtPtr; const filename: wasPChar; const encoding: wasPChar; options: Longint) : htmlDocPtr; cdecl; external LIBXML2_SO;
  function htmlCtxtReadIO (ctxt: htmlParserCtxtPtr; ioread: xmlInputReadCallback; ioclose: xmlInputCloseCallback; ioctx: Pointer; const URL: wasPChar; const encoding: wasPChar; options: Longint) : htmlDocPtr; cdecl; external LIBXML2_SO;
  function htmlCtxtReadMemory (ctxt: htmlParserCtxtPtr; const buffer: wasPChar; size: Longint; const URL: wasPChar; const encoding: wasPChar; options: Longint) : htmlDocPtr; cdecl; external LIBXML2_SO;
  ...
  procedure htmlDocContentDumpFormatOutput (buf: xmlOutputBufferPtr; cur: xmlDocPtr; const encoding: wasPChar; format: Longint); cdecl; external LIBXML2_SO;
  procedure htmlDocContentDumpOutput (buf: xmlOutputBufferPtr; cur: xmlDocPtr; const encoding: wasPChar); cdecl; external LIBXML2_SO;
  ...
  function htmlNodeDumpFileFormat (out_: PFILE; doc: xmlDocPtr; cur: xmlNodePtr; const encoding: wasPChar; format: Longint) : Longint; cdecl; external LIBXML2_SO;
  procedure htmlNodeDumpFormatOutput (buf: xmlOutputBufferPtr; doc: xmlDocPtr; cur: xmlNodePtr; const encoding: wasPChar; format: Longint); cdecl; external LIBXML2_SO;
  procedure htmlNodeDumpOutput (buf: xmlOutputBufferPtr; doc: xmlDocPtr; cur: xmlNodePtr; const encoding: wasPChar); cdecl; external LIBXML2_SO;
  ...
  function htmlParseChunk (ctxt: htmlParserCtxtPtr; const chunk: wasPChar; size: Longint; terminate: Longint) : Longint; cdecl; external LIBXML2_SO;
  function htmlParseDoc (cur: xmlCharPtr; const encoding: wasPChar) : htmlDocPtr; cdecl; external LIBXML2_SO;
  ...
  function htmlParseFile (const filename: wasPChar; const encoding: wasPChar) : htmlDocPtr; cdecl; external LIBXML2_SO;
  function htmlReadDoc (const cur: xmlCharPtr; const URL: wasPChar; const encoding: wasPChar; options: Longint) : htmlDocPtr; cdecl; external LIBXML2_SO;
  function htmlReadFd (fd: Longint; const URL: wasPChar; const encoding: wasPChar; options: Longint) : htmlDocPtr; cdecl; external LIBXML2_SO;
  function htmlReadFile (const filename: wasPChar; const encoding: wasPChar; options: Longint) : htmlDocPtr; cdecl; external LIBXML2_SO;
  function htmlReadIO (ioread: xmlInputReadCallback; ioclose: xmlInputCloseCallback; ioctx: Pointer; const URL: wasPChar; const encoding: wasPChar; options: Longint) : htmlDocPtr; cdecl; external LIBXML2_SO;
  function htmlReadMemory (const buffer: wasPChar; size: Longint; const URL: wasPChar; const encoding: wasPChar; options: Longint) : htmlDocPtr; cdecl; external LIBXML2_SO;
  function htmlSAXParseDoc (cur: xmlCharPtr; const encoding: wasPChar; sax: htmlSAXHandlerPtr; userData: Pointer) : htmlDocPtr; cdecl; external LIBXML2_SO;
  function htmlSAXParseFile (const filename: wasPChar; const encoding: wasPChar; sax: htmlSAXHandlerPtr; userData: Pointer) : htmlDocPtr; cdecl; external LIBXML2_SO;
  function htmlSaveFile (const filename: wasPChar; cur: xmlDocPtr) : Longint; cdecl; external LIBXML2_SO;
  function htmlSaveFileEnc (const filename: wasPChar; cur: xmlDocPtr; const encoding: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  function htmlSaveFileFormat (const filename: wasPChar; cur: xmlDocPtr; const encoding: wasPChar; format: Longint) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlAddEncodingAlias (const name: wasPChar; const alias: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlBoolToText (boolval: Longint) : wasPChar; cdecl; external LIBXML2_SO;
  ...
  function xmlBufferCCat (buf: xmlBufferPtr; const str: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  ...
  procedure xmlBufferWriteChar (buf: xmlBufferPtr; const string_: wasPChar); cdecl; external LIBXML2_SO;
  ...
  function xmlC14NDocSave (doc: xmlDocPtr; nodes: xmlNodeSetPtr; exclusive: Longint; inclusive_ns_prefixes: xmlCharPtrPtr; with_comments: Longint; const filename: wasPChar; compression: Longint) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlCharStrdup (const cur: wasPChar) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlCharStrndup (const cur: wasPChar; len: Longint) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlCheckFilename (const path: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlCreateFileParserCtxt (const filename: wasPChar) : xmlParserCtxtPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlCreateMemoryParserCtxt (const buffer: wasPChar; size: Longint) : xmlParserCtxtPtr; cdecl; external LIBXML2_SO;
  function xmlCreatePushParserCtxt (sax: xmlSAXHandlerPtr; user_data: Pointer; const chunk: wasPChar; size: Longint; const filename: wasPChar) : xmlParserCtxtPtr; cdecl; external LIBXML2_SO;
  function xmlCreateURI () : xmlURIPtr; cdecl; external LIBXML2_SO;
  function xmlCreateURLParserCtxt (const filename: wasPChar; options: Longint) : xmlParserCtxtPtr; cdecl; external LIBXML2_SO;
  function xmlCtxtGetLastError (ctx: Pointer) : xmlErrorPtr; cdecl; external LIBXML2_SO;
  function xmlCtxtReadDoc (ctxt: xmlParserCtxtPtr; const cur: xmlCharPtr; const URL: wasPChar; const encoding: wasPChar; options: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlCtxtReadFd (ctxt: xmlParserCtxtPtr; fd: Longint; const URL: wasPChar; const encoding: wasPChar; options: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlCtxtReadFile (ctxt: xmlParserCtxtPtr; const filename: wasPChar; const encoding: wasPChar; options: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlCtxtReadIO (ctxt: xmlParserCtxtPtr; ioread: xmlInputReadCallback; ioclose: xmlInputCloseCallback; ioctx: Pointer; const URL: wasPChar; const encoding: wasPChar; options: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlCtxtReadMemory (ctxt: xmlParserCtxtPtr; const buffer: wasPChar; size: Longint; const URL: wasPChar; const encoding: wasPChar; options: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlCtxtResetPush (ctxt: xmlParserCtxtPtr; const chunk: wasPChar; size: Longint; const filename: wasPChar; const encoding: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlDelEncodingAlias (const alias: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  ...
  procedure xmlDocDumpFormatMemoryEnc (out_doc: xmlDocPtr; doc_txt_ptr: xmlCharPtrPtr; doc_txt_len: PInteger; const txt_encoding: wasPChar; format: Longint); cdecl; external LIBXML2_SO;
  procedure xmlDocDumpMemory (cur: xmlDocPtr; mem: xmlCharPtrPtr; size: PInteger); cdecl; external LIBXML2_SO;
  procedure xmlDocDumpMemoryEnc (out_doc: xmlDocPtr; doc_txt_ptr: xmlCharPtrPtr; doc_txt_len: PInteger; const txt_encoding: wasPChar); cdecl; external LIBXML2_SO;
  ...
  procedure xmlErrMemory (ctxt: xmlParserCtxtPtr; const extra: wasPChar); cdecl; external LIBXML2_SO;
  ...
  function xmlExpParse (ctxt: xmlExpCtxtPtr; const expr: wasPChar) : xmlExpNodePtr; cdecl; external LIBXML2_SO;
  ...
  function xmlFileMatch (const filename: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  function xmlFileOpen (const filename: wasPChar) : Pointer; cdecl; external LIBXML2_SO;
  function xmlFileRead (context: Pointer; buffer: wasPChar; len: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlFindCharEncodingHandler (const name: wasPChar) : xmlCharEncodingHandlerPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlGetCharEncodingName (enc: xmlCharEncoding) : wasPChar; cdecl; external LIBXML2_SO;
  ...
  function xmlGetEncodingAlias (const alias: wasPChar) : wasPChar; cdecl; external LIBXML2_SO;
  function xmlGetExternalEntityLoader () : xmlExternalEntityLoader; cdecl; external LIBXML2_SO;
  function xmlGetFeature (ctxt: xmlParserCtxtPtr; const name: wasPChar; result: Pointer) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlIOFTPMatch (const filename: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  function xmlIOFTPOpen (const filename: wasPChar) : Pointer; cdecl; external LIBXML2_SO;
  function xmlIOFTPRead (context: Pointer; buffer: wasPChar; len: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlIOHTTPClose (context: Pointer) : Longint; cdecl; external LIBXML2_SO;
  function xmlIOHTTPMatch (const filename: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  function xmlIOHTTPOpen (const filename: wasPChar) : Pointer; cdecl; external LIBXML2_SO;
  function xmlIOHTTPOpenW (const post_uri: wasPChar; compression: Longint) : Pointer; cdecl; external LIBXML2_SO;
  function xmlIOHTTPRead (context: Pointer; buffer: wasPChar; len: Longint) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlLoadACatalog (const filename: wasPChar) : xmlCatalogPtr; cdecl; external LIBXML2_SO;
  function xmlLoadCatalog (const filename: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  procedure xmlLoadCatalogs (const pathss: wasPChar); cdecl; external LIBXML2_SO;
  function xmlLoadExternalEntity (const URL: wasPChar; const ID: wasPChar; ctxt: xmlParserCtxtPtr) : xmlParserInputPtr; cdecl; external LIBXML2_SO;
  function xmlLoadSGMLSuperCatalog (const filename: wasPChar) : xmlCatalogPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlMallocAtomicLoc (size: size_t; const file_: wasPChar; line: Longint) : Pointer; cdecl; external LIBXML2_SO;
  function xmlMallocLoc (size: size_t; const file_: wasPChar; line: Longint) : Pointer; cdecl; external LIBXML2_SO;
  ...
  function xmlMemStrdupLoc (const str: wasPChar; const file_: wasPChar; line: Longint) : wasPChar; cdecl; external LIBXML2_SO;
  function xmlMemUsed () : Longint; cdecl; external LIBXML2_SO;
  procedure xmlMemoryDump (); cdecl; external LIBXML2_SO;
  function xmlMemoryStrdup (const str: wasPChar) : wasPChar; cdecl; external LIBXML2_SO;
  ...
  function xmlModuleOpen (const name: wasPChar; options: Longint) : xmlModulePtr; cdecl; external LIBXML2_SO;
  function xmlModuleSymbol (module: xmlModulePtr; const name: wasPChar; symbol: PPointer) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlNanoFTPConnectTo (const server: wasPChar; port: Longint) : Pointer; cdecl; external LIBXML2_SO;
  function xmlNanoFTPCwd (ctx: Pointer; const directory: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  function xmlNanoFTPDele (ctx: Pointer; const file_: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  procedure xmlNanoFTPFreeCtxt (ctx: Pointer); cdecl; external LIBXML2_SO;
  function xmlNanoFTPGet (ctx: Pointer; callback: ftpDataCallback; userData: Pointer; const filename: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlNanoFTPGetSocket (ctx: Pointer; const filename: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  procedure xmlNanoFTPInit (); cdecl; external LIBXML2_SO;
  function xmlNanoFTPList (ctx: Pointer; callback: ftpListCallback; userData: Pointer; const filename: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  function xmlNanoFTPNewCtxt (const URL: wasPChar) : Pointer; cdecl; external LIBXML2_SO;
  function xmlNanoFTPOpen (const URL: wasPChar) : Pointer; cdecl; external LIBXML2_SO;
  procedure xmlNanoFTPProxy (const host: wasPChar; port: Longint; const user: wasPChar; const passwd: wasPChar; type_: Longint); cdecl; external LIBXML2_SO;
  ...
  procedure xmlNanoFTPScanProxy (const URL: wasPChar); cdecl; external LIBXML2_SO;
  function xmlNanoFTPUpdateURL (ctx: Pointer; const URL: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  function xmlNanoHTTPAuthHeader (ctx: Pointer) : wasPChar; cdecl; external LIBXML2_SO;
  ...
  function xmlNanoHTTPEncoding (ctx: Pointer) : wasPChar; cdecl; external LIBXML2_SO;
  function xmlNanoHTTPFetch (const URL: wasPChar; const filename: wasPChar; contentType: PPChar) : Longint; cdecl; external LIBXML2_SO;
  procedure xmlNanoHTTPInit (); cdecl; external LIBXML2_SO;
  function xmlNanoHTTPMethod (const URL: wasPChar; const method: wasPChar; const input: wasPChar; contentType: PPChar; const headers: wasPChar; ilen: Longint) : Pointer; cdecl; external LIBXML2_SO;
  function xmlNanoHTTPMethodRedir (const URL: wasPChar; const method: wasPChar; const input: wasPChar; contentType: PPChar; redir: PPChar; const headers: wasPChar; ilen: Longint) : Pointer; cdecl; external LIBXML2_SO;
  function xmlNanoHTTPMimeType (ctx: Pointer) : wasPChar; cdecl; external LIBXML2_SO;
  function xmlNanoHTTPOpen (const URL: wasPChar; contentType: PPChar) : Pointer; cdecl; external LIBXML2_SO;
  function xmlNanoHTTPOpenRedir (const URL: wasPChar; contentType: PPChar; redir: PPChar) : Pointer; cdecl; external LIBXML2_SO;
  function xmlNanoHTTPRead (ctx: Pointer; dest: Pointer; len: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlNanoHTTPRedir (ctx: Pointer) : wasPChar; cdecl; external LIBXML2_SO;
  function xmlNanoHTTPReturnCode (ctx: Pointer) : Longint; cdecl; external LIBXML2_SO;
  function xmlNanoHTTPSave (ctxt: Pointer; const filename: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  procedure xmlNanoHTTPScanProxy (const URL: wasPChar); cdecl; external LIBXML2_SO;
  ...
  function xmlNewCharEncodingHandler (const name: wasPChar; input: xmlCharEncodingInputFunc; output: xmlCharEncodingOutputFunc) : xmlCharEncodingHandlerPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlNewInputFromFile (ctxt: xmlParserCtxtPtr; const filename: wasPChar) : xmlParserInputPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlNewTextReader (input: xmlParserInputBufferPtr; const URI: wasPChar) : xmlTextReaderPtr; cdecl; external LIBXML2_SO;
  function xmlNewTextReaderFilename (const URI: wasPChar) : xmlTextReaderPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlNewTextWriterFilename (const uri: wasPChar; compression: Longint) : xmlTextWriterPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlNoNetExternalEntityLoader (const URL: wasPChar; const ID: wasPChar; ctxt: xmlParserCtxtPtr) : xmlParserInputPtr; cdecl; external LIBXML2_SO;
  ...
  procedure xmlNodeDumpOutput (buf: xmlOutputBufferPtr; doc: xmlDocPtr; cur: xmlNodePtr; level: Longint; format: Longint; const encoding: wasPChar); cdecl; external LIBXML2_SO;
  ...
  function xmlNormalizeURIPath (path: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlOutputBufferCreateFilename (const URI: wasPChar; encoder: xmlCharEncodingHandlerPtr; compression: Longint) : xmlOutputBufferPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlOutputBufferWrite (out_: xmlOutputBufferPtr; len: Longint; const buf: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlOutputBufferWriteString (out_: xmlOutputBufferPtr; const str: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlParseCatalogFile (const filename: wasPChar) : xmlDocPtr; cdecl; external LIBXML2_SO;
  procedure xmlParseCharData (ctxt: xmlParserCtxtPtr; cdata: Longint); cdecl; external LIBXML2_SO;
  function xmlParseCharEncoding (const name: wasPChar) : xmlCharEncoding; cdecl; external LIBXML2_SO;
  function xmlParseCharRef (ctxt: xmlParserCtxtPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlParseChunk (ctxt: xmlParserCtxtPtr; const chunk: wasPChar; size: Longint; terminate: Longint) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlParseEntity (const filename: wasPChar) : xmlDocPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlParseFile (const filename: wasPChar) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlParseInNodeContext (node: xmlNodePtr; const data: wasPChar; datalen: Longint; options: Longint; lst: xmlNodePtrPtr) : xmlParserErrors; cdecl; external LIBXML2_SO;
  procedure xmlParseMarkupDecl (ctxt: xmlParserCtxtPtr); cdecl; external LIBXML2_SO;
  function xmlParseMemory (const buffer: wasPChar; size: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlParseURI (const str: wasPChar) : xmlURIPtr; cdecl; external LIBXML2_SO;
  function xmlParseURIRaw (const str: wasPChar; raw: Longint) : xmlURIPtr; cdecl; external LIBXML2_SO;
  function xmlParseURIReference (uri: xmlURIPtr; const str: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  ...
  procedure xmlParserError (ctx: Pointer; const msg: wasPChar); cdecl; varargs; external LIBXML2_SO;
  ...
  function xmlParserGetDirectory (const filename: wasPChar) : wasPChar; cdecl; external LIBXML2_SO;
  ...
  function xmlParserInputBufferCreateFilename (const URI: wasPChar; enc: xmlCharEncoding) : xmlParserInputBufferPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlParserInputBufferCreateMem (const mem: wasPChar; size: Longint; enc: xmlCharEncoding) : xmlParserInputBufferPtr; cdecl; external LIBXML2_SO;
  function xmlParserInputBufferCreateStatic (const mem: wasPChar; size: Longint; enc: xmlCharEncoding) : xmlParserInputBufferPtr; cdecl; external LIBXML2_SO;
  function xmlParserInputBufferGrow (in_: xmlParserInputBufferPtr; len: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlParserInputBufferPush (in_: xmlParserInputBufferPtr; len: Longint; const buf: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  ...
  procedure xmlParserValidityError (ctx: Pointer; const msg: wasPChar); cdecl; varargs; external LIBXML2_SO;
  procedure xmlParserValidityWarning (ctx: Pointer; const msg: wasPChar); cdecl; varargs; external LIBXML2_SO;
  procedure xmlParserWarning (ctx: Pointer; const msg: wasPChar); cdecl; varargs; external LIBXML2_SO;
  ...
  function xmlReadDoc (const cur: xmlCharPtr; const URL: wasPChar; const encoding: wasPChar; options: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlReadFd (fd: Longint; const URL: wasPChar; const encoding: wasPChar; options: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlReadFile (const filename: wasPChar; const encoding: wasPChar; options: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlReadIO (ioread: xmlInputReadCallback; ioclose: xmlInputCloseCallback; ioctx: Pointer; const URL: wasPChar; const encoding: wasPChar; options: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlReadMemory (const buffer: wasPChar; size: Longint; const URL: wasPChar; const encoding: wasPChar; options: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlReaderForDoc (const cur: xmlCharPtr; const URL: wasPChar; const encoding: wasPChar; options: Longint) : xmlTextReaderPtr; cdecl; external LIBXML2_SO;
  function xmlReaderForFd (fd: Longint; const URL: wasPChar; const encoding: wasPChar; options: Longint) : xmlTextReaderPtr; cdecl; external LIBXML2_SO;
  function xmlReaderForFile (const filename: wasPChar; const encoding: wasPChar; options: Longint) : xmlTextReaderPtr; cdecl; external LIBXML2_SO;
  function xmlReaderForIO (ioread: xmlInputReadCallback; ioclose: xmlInputCloseCallback; ioctx: Pointer; const URL: wasPChar; const encoding: wasPChar; options: Longint) : xmlTextReaderPtr; cdecl; external LIBXML2_SO;
  function xmlReaderForMemory (const buffer: wasPChar; size: Longint; const URL: wasPChar; const encoding: wasPChar; options: Longint) : xmlTextReaderPtr; cdecl; external LIBXML2_SO;
  function xmlReaderNewDoc (reader: xmlTextReaderPtr; const cur: xmlCharPtr; const URL: wasPChar; const encoding: wasPChar; options: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlReaderNewFd (reader: xmlTextReaderPtr; fd: Longint; const URL: wasPChar; const encoding: wasPChar; options: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlReaderNewFile (reader: xmlTextReaderPtr; const filename: wasPChar; const encoding: wasPChar; options: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlReaderNewIO (reader: xmlTextReaderPtr; ioread: xmlInputReadCallback; ioclose: xmlInputCloseCallback; ioctx: Pointer; const URL: wasPChar; const encoding: wasPChar; options: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlReaderNewMemory (reader: xmlTextReaderPtr; const buffer: wasPChar; size: Longint; const URL: wasPChar; const encoding: wasPChar; options: Longint) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlReallocLoc (ptr: Pointer; size: size_t; const file_: wasPChar; line: Longint) : Pointer; cdecl; external LIBXML2_SO;
  ...
  function xmlRecoverFile (const filename: wasPChar) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlRecoverMemory (const buffer: wasPChar; size: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlRelaxNGNewMemParserCtxt (const buffer: wasPChar; size: Longint) : xmlRelaxNGParserCtxtPtr; cdecl; external LIBXML2_SO;
  function xmlRelaxNGNewParserCtxt (const URL: wasPChar) : xmlRelaxNGParserCtxtPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlSAXParseEntity (sax: xmlSAXHandlerPtr; const filename: wasPChar) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlSAXParseFile (sax: xmlSAXHandlerPtr; const filename: wasPChar; recovery: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlSAXParseFileWithData (sax: xmlSAXHandlerPtr; const filename: wasPChar; recovery: Longint; data: Pointer) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlSAXParseMemory (sax: xmlSAXHandlerPtr; const buffer: wasPChar; size: Longint; recovery: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlSAXParseMemoryWithData (sax: xmlSAXHandlerPtr; const buffer: wasPChar; size: Longint; recovery: Longint; data: Pointer) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlSAXUserParseFile (sax: xmlSAXHandlerPtr; user_data: Pointer; const filename: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  function xmlSAXUserParseMemory (sax: xmlSAXHandlerPtr; user_data: Pointer; const buffer: wasPChar; size: Longint) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlSaveFile (const filename: wasPChar; cur: xmlDocPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlSaveFileEnc (const filename: wasPChar; cur: xmlDocPtr; const encoding: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  function xmlSaveFileTo (buf: xmlOutputBufferPtr; cur: xmlDocPtr; const encoding: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  function xmlSaveFlush (ctxt: xmlSaveCtxtPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlSaveFormatFile (const filename: wasPChar; cur: xmlDocPtr; format: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlSaveFormatFileEnc (const filename: wasPChar; cur: xmlDocPtr; const encoding: wasPChar; format: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlSaveFormatFileTo (buf: xmlOutputBufferPtr; cur: xmlDocPtr; const encoding: wasPChar; format: Longint) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlSaveToBuffer (buffer: xmlBufferPtr; const encoding: wasPChar; options: Longint) : xmlSaveCtxtPtr; cdecl; external LIBXML2_SO;
  function xmlSaveToFd (fd: Longint; const encoding: wasPChar; options: Longint) : xmlSaveCtxtPtr; cdecl; external LIBXML2_SO;
  function xmlSaveToFilename (const filename: wasPChar; const encoding: wasPChar; options: Longint) : xmlSaveCtxtPtr; cdecl; external LIBXML2_SO;
  function xmlSaveToIO (iowrite: xmlOutputWriteCallback; ioclose: xmlOutputCloseCallback; ioctx: Pointer; const encoding: wasPChar; options: Longint) : xmlSaveCtxtPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlSchemaNewMemParserCtxt (const buffer: wasPChar; size: Longint) : xmlSchemaParserCtxtPtr; cdecl; external LIBXML2_SO;
  function xmlSchemaNewNOTATIONValue (const name: xmlCharPtr; const ns: xmlCharPtr) : xmlSchemaValPtr; cdecl; external LIBXML2_SO;
  function xmlSchemaNewParserCtxt (const URL: wasPChar) : xmlSchemaParserCtxtPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlSchemaValidateFile (ctxt: xmlSchemaValidCtxtPtr; const filename: wasPChar; options: Longint) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlSchematronNewMemParserCtxt (const buffer: wasPChar; size: Longint) : xmlSchematronParserCtxtPtr; cdecl; external LIBXML2_SO;
  function xmlSchematronNewParserCtxt (const URL: wasPChar) : xmlSchematronParserCtxtPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlSetFeature (ctxt: xmlParserCtxtPtr; const name: wasPChar; value: Pointer) : Longint; cdecl; external LIBXML2_SO;
  ...
  procedure xmlSetupParserForBuffer (ctxt: xmlParserCtxtPtr; const buffer: xmlCharPtr; const filename: wasPChar); cdecl; external LIBXML2_SO;
  procedure xmlShell (doc: xmlDocPtr; filename: wasPChar; input: xmlShellReadlineFunc; output: PFILE); cdecl; external LIBXML2_SO;
  function xmlShellBase (ctxt: xmlShellCtxtPtr; arg: wasPChar; node: xmlNodePtr; node2: xmlNodePtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlShellCat (ctxt: xmlShellCtxtPtr; arg: wasPChar; node: xmlNodePtr; node2: xmlNodePtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlShellDir (ctxt: xmlShellCtxtPtr; arg: wasPChar; node: xmlNodePtr; node2: xmlNodePtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlShellDu (ctxt: xmlShellCtxtPtr; arg: wasPChar; tree: xmlNodePtr; node2: xmlNodePtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlShellList (ctxt: xmlShellCtxtPtr; arg: wasPChar; node: xmlNodePtr; node2: xmlNodePtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlShellLoad (ctxt: xmlShellCtxtPtr; filename: wasPChar; node: xmlNodePtr; node2: xmlNodePtr) : Longint; cdecl; external LIBXML2_SO;
  procedure xmlShellPrintNode (node: xmlNodePtr); cdecl; external LIBXML2_SO;
  procedure xmlShellPrintXPathError (errorType: Longint; const arg: wasPChar); cdecl; external LIBXML2_SO;
  procedure xmlShellPrintXPathResult (list: xmlXPathObjectPtr); cdecl; external LIBXML2_SO;
  function xmlShellPwd (ctxt: xmlShellCtxtPtr; buffer: wasPChar; node: xmlNodePtr; node2: xmlNodePtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlShellSave (ctxt: xmlShellCtxtPtr; filename: wasPChar; node: xmlNodePtr; node2: xmlNodePtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlShellValidate (ctxt: xmlShellCtxtPtr; dtd: wasPChar; node: xmlNodePtr; node2: xmlNodePtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlShellWrite (ctxt: xmlShellCtxtPtr; filename: wasPChar; node: xmlNodePtr; node2: xmlNodePtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlSkipBlankChars (ctxt: xmlParserCtxtPtr) : Longint; cdecl; external LIBXML2_SO;
  procedure xmlSnprintfElementContent (buf: wasPChar; size: Longint; content: xmlElementContentPtr; englob: Longint); cdecl; external LIBXML2_SO;
  ...
  procedure xmlSprintfElementContent (buf: wasPChar; content: xmlElementContentPtr; englob: Longint); cdecl; external LIBXML2_SO;
  ...
  function xmlTextReaderRelaxNGValidate (reader: xmlTextReaderPtr; const rng: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextReaderSchemaValidate (reader: xmlTextReaderPtr; const xsd: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlTextReaderSetup (reader: xmlTextReaderPtr; input: xmlParserInputBufferPtr; const URL: wasPChar; const encoding: wasPChar; options: Longint) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlTextWriterStartDocument (writer: xmlTextWriterPtr; const version: wasPChar; const encoding: wasPChar; const standalone: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlTextWriterWriteBase64 (writer: xmlTextWriterPtr; const data: wasPChar; start: Longint; len: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteBinHex (writer: xmlTextWriterPtr; const data: wasPChar; start: Longint; len: Longint) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlTextWriterWriteFormatAttribute (writer: xmlTextWriterPtr; const name: xmlCharPtr; const format: wasPChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWriteFormatAttributeNS (writer: xmlTextWriterPtr; const prefix: xmlCharPtr; const name: xmlCharPtr; const namespaceURI: xmlCharPtr; const format: wasPChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWriteFormatCDATA (writer: xmlTextWriterPtr; const format: wasPChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWriteFormatComment (writer: xmlTextWriterPtr; const format: wasPChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWriteFormatDTD (writer: xmlTextWriterPtr; const name: xmlCharPtr; const pubid: xmlCharPtr; const sysid: xmlCharPtr; const format: wasPChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWriteFormatDTDAttlist (writer: xmlTextWriterPtr; const name: xmlCharPtr; const format: wasPChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWriteFormatDTDElement (writer: xmlTextWriterPtr; const name: xmlCharPtr; const format: wasPChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWriteFormatDTDInternalEntity (writer: xmlTextWriterPtr; pe: Longint; const name: xmlCharPtr; const format: wasPChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWriteFormatElement (writer: xmlTextWriterPtr; const name: xmlCharPtr; const format: wasPChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWriteFormatElementNS (writer: xmlTextWriterPtr; const prefix: xmlCharPtr; const name: xmlCharPtr; const namespaceURI: xmlCharPtr; const format: wasPChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWriteFormatPI (writer: xmlTextWriterPtr; const target: xmlCharPtr; const format: wasPChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWriteFormatRaw (writer: xmlTextWriterPtr; const format: wasPChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWriteFormatString (writer: xmlTextWriterPtr; const format: wasPChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  ...
  function xmlTextWriterWriteVFormatAttribute (writer: xmlTextWriterPtr; const name: xmlCharPtr; const format: wasPChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatAttributeNS (writer: xmlTextWriterPtr; const prefix: xmlCharPtr; const name: xmlCharPtr; const namespaceURI: xmlCharPtr; const format: wasPChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatCDATA (writer: xmlTextWriterPtr; const format: wasPChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatComment (writer: xmlTextWriterPtr; const format: wasPChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatDTD (writer: xmlTextWriterPtr; const name: xmlCharPtr; const pubid: xmlCharPtr; const sysid: xmlCharPtr; const format: wasPChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatDTDAttlist (writer: xmlTextWriterPtr; const name: xmlCharPtr; const format: wasPChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatDTDElement (writer: xmlTextWriterPtr; const name: xmlCharPtr; const format: wasPChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatDTDInternalEntity (writer: xmlTextWriterPtr; pe: Longint; const name: xmlCharPtr; const format: wasPChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatElement (writer: xmlTextWriterPtr; const name: xmlCharPtr; const format: wasPChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatElementNS (writer: xmlTextWriterPtr; const prefix: xmlCharPtr; const name: xmlCharPtr; const namespaceURI: xmlCharPtr; const format: wasPChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatPI (writer: xmlTextWriterPtr; const target: xmlCharPtr; const format: wasPChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatRaw (writer: xmlTextWriterPtr; const format: wasPChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatString (writer: xmlTextWriterPtr; const format: wasPChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlThrDefTreeIndentString (const v: wasPChar) : wasPChar; cdecl; external LIBXML2_SO;
  ...
  function xmlUCSIsBlock (code: Longint; const block: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlUCSIsCat (code: Longint; const cat: wasPChar) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlURIUnescapeString (const str: wasPChar; len: Longint; target: wasPChar) : wasPChar; cdecl; external LIBXML2_SO;
  ...
  function xmlXPathNewCString (const val: wasPChar) : xmlXPathObjectPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlXPathWrapCString (val: wasPChar) : xmlXPathObjectPtr; cdecl; external LIBXML2_SO;
  ...
  procedure xmlXPatherror (ctxt: xmlXPathParserContextPtr; const file_: wasPChar; line: Longint; no: Longint); cdecl; external LIBXML2_SO;
...
var
  ...
  function xmlMemStrdup (const str: wasPChar) : wasPChar; cdecl;
...
var
  xmlStringComment: wasPChar;
var
  xmlStringText: wasPChar;
var
  xmlStringTextNoenc: wasPChar;
...
initialization
  ...
  begin
    ...
    xmlStringComment := wasPChar(GetProcAddress(libHandle, 'xmlStringComment'));
    xmlStringText := wasPChar(GetProcAddress(libHandle, 'xmlStringText'));
    xmlStringTextNoenc := wasPChar(GetProcAddress(libHandle, 'xmlStringTextNoenc'));
