...
function TSysHotKey.AddHotKey(VirtKey: TVirtKey; Modifiers: THKModifiers): THotKeyItem;
var
  pItem : PHotKeyItem;
  iItem : Integer;
begin
  ...
  if Active then RegisterHotKeyNr(iItem);
  Result := pItem^;
end;
...
procedure Register;
begin
  RegisterComponents('ANFiX', [TSysHotKey]);
end;
