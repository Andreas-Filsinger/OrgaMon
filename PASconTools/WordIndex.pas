...
const
  ...
  c_wi_TranslateFrom : string = 'ßÄËÖÜÁÀÉÈÚÙÓÍÊÇÅ';
  c_wi_TranslateTo : string  = 'SAEOUAAEEUUOIECA';
  c_wi_ValidChars : string  = '~ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789' + 'ßÄËÖÜÁÀÉÈÚÙÓÍÊÇÅ';
  c_wi_ValidCharsSort : string  = '~ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789' + 'SAEOUAAEEUUOIECA';
  c_wi_WhiteSpace_noblank  : string = '_()*+-:&§",/!?=;<>#{}$%''´`^' + #$0D;
  c_wi_WhiteSpace_exact  : string = ' ' + '_()*+-:&§",/!?=;<>#{}$%''´`^' + #$0D;
  c_wi_WhiteSpace  : string = '.' + ' ' + '_()*+-:&§",/!?=;<>#{}$%''´`^' + #$0D;
...
begin
 ...
 writeln('2) Über');
 writeln(UTF8ToConsole('Über'));
 writeln(AnsiToUTF8('Über'));
