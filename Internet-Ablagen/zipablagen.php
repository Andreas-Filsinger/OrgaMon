...
if (file_exists("ampel.gif")===TRUE) {
  define('AMPEL_GIF',"ampel.gif");
} else {
  define('AMPEL_GIF',"ampel-horizontal.gif"); 
} 
...
if ($_SERVER['SERVER_PORT']==80) {
 ...
 $NewLink = "https:/" . $actpath . ".orgamon.org/";
 echo "<center>";
 echo "Eine verschlüsselte Variante dieser Dateiablage ist nun verfügbar. Bitte verwenden Sie diesen neuen Link:<br><br>";
...
<tr><td colspan=4><br><br><b>Foto-Dateiablage [<a href="https://wiki.orgamon.org/?title=CMS.Dateiablage">Hilfe</a>]</b>
</td></tr>
<tr>
<td bgcolor="#C8D8E0">
Status
...
if ($handle = opendir('.')) { 
 ...
 while (false !== ($file = readdir($handle))) { 
    ...
    if (strpos($file,'.') === false) {
      echo "Unterverzeichnis <a href=" . $file . ">" . $file . "</a><br>";
    }
...
for ($i = 0; $i < $n; $i++) 
 { $fn = $filename[$i];
   ...
   echo "&wC=" . getState($fn);
   echo "\"><img src=\"" . AMPEL_GIF . "\" border=0></a>";
   echo "</td>\n";
...
<tr><td colspan=4><br><br><b>zip-Dateiablage [<a href="https://wiki.orgamon.org/?title=CMS.Dateiablage">Hilfe</a>]</b><br>
</td></tr>
<tr>
<td bgcolor="#C8D8E0">
Status
...
OrgaMon&trade; Rev 8.542 &copy;1987-2020 https://wiki.orgamon.org, 
<?php
