object FormAuftragBildzuordnung: TFormAuftragBildzuordnung
  Left = 0
  Top = 0
  ...
  object Label1: TLabel
    ...
    Width = 196
    Height = 16
    Caption = 'OrgaMon'#8482' Bilder zuordnen'
  ...
  object CheckBox1: TCheckBox
    ...
    Width = 231
    Height = 17
    Caption = 'die '#228'ltesten Bilder zuerst anzeigen'
    Checked = True
    State = cbChecked
    TabOrder = 4
  ...
  object CheckBox4: TCheckBox
    ...
    Width = 234
    Height = 17
    Caption = 'Z'#228'hlernummer Neu anzeigen'
    TabOrder = 16
  end
  object Edit4: TEdit
    Left = 199
  ...
  object IB_Query1: TIB_Query
    ...
    SQL.Strings = (
      ...
      ' auftrag '
      'where'
      ' (baustelle_R=:BAUSTELLE) and'
      ' (zaehler_wechsel between :VON and :BIS) and'
      ' (status<>6)'
      'order by'
      ' zaehler_wechsel')
    OrderingItems.Strings = (
      'ZAEHLER_NUMMER=ZAEHLER_NUMMER;ZAEHLER_NUMMER DESC'
      'ZAEHLER_WECHSEL=ZAEHLER_WECHSEL;ZAEHLER_WECHSEL DESC')
    OrderingLinks.Strings = (
      'ZAEHLER_NUMMER=ITEM=1'
      'ZAEHLER_WECHSEL=ITEM=2')
