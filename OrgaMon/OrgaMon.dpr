...
uses
  ...
  Funktionen.Basis in 'Funktionen.Basis.pas',
  Funktionen.Beleg in 'Funktionen.Beleg.pas',
  Funktionen.Auftrag in 'Funktionen.Auftrag.pas',
  Funktionen.Buch in 'Funktionen.Buch.pas',
  uPSI_eConnect in 'uPSI_eConnect.pas',
  uPSI_Funktionen_Auftrag in 'uPSI_Funktionen_Auftrag.pas',
  uPSI_Funktionen_Basis in 'uPSI_Funktionen_Basis.pas',
  uPSI_Funktionen_Beleg in 'uPSI_Funktionen_Beleg.pas',
  uPSI_Funktionen_Buch in 'uPSI_Funktionen_Buch.pas',
  ArtikelKasse in 'ArtikelKasse.pas' {FormArtikelKasse},
  ArtikelPOS in 'ArtikelPOS.pas' {FormArtikelPOS},
  Funktionen.Transaktion in 'Funktionen.Transaktion.pas',
  Funktionen.LokaleDaten in 'Funktionen.LokaleDaten.pas',
