...
type 
(*----------------------------------------------------------------------------*)
  TPSImport_Funktionen.Auftrag = class(TPSPlugin)
  public
...
procedure SIRegister_Funktionen.Auftrag(CL: TPSPascalCompiler);

{ run-time registration functions }
procedure RIRegister_Funktionen.Auftrag_Routines(S: TPSExec);
...
procedure Register;
begin
  RegisterComponents('Pascal Script', [TPSImport_Funktionen.Auftrag]);
end;
...
Begin Result := ParserU.e_r_Verlag_R(rid); END;

(*----------------------------------------------------------------------------*)
Procedure AuftragHistorischerDatensatz2_P( AUFTRAG_R : TList);
Begin ParserU.AuftragHistorischerDatensatz(AUFTRAG_R); END;

(*----------------------------------------------------------------------------*)
procedure RIRegister_Funktionen.Auftrag_Routines(S: TPSExec);
begin
 S.RegisterDelphiFunction(@AuftragHistorischerDatensatz, 'AuftragHistorischerDatensatz', cdRegister);
 S.RegisterDelphiFunction(@AuftragHistorischerDatensatz2, 'AuftragHistorischerDatensatz2', cdRegister);
 ...
 S.RegisterDelphiFunction(@e_r_Verlag_R2, 'e_r_Verlag_R2', cdRegister);
 ...
 S.RegisterDelphiFunction(@SplitStrasse, 'SplitStrasse', cdRegister);
...
{ TPSImport_Funktionen.Auftrag }
(*----------------------------------------------------------------------------*)
procedure TPSImport_Funktionen.Auftrag.CompileImport1(CompExec: TPSScript);
begin
  SIRegister_Funktionen.Auftrag(CompExec.Comp);
end;
(*----------------------------------------------------------------------------*)
procedure TPSImport_Funktionen.Auftrag.ExecImport1(CompExec: TPSScript; const ri: TPSRuntimeClassImporter);
begin
  RIRegister_Funktionen.Auftrag_Routines(CompExec.Exec); // comment it if no routines
end;
(*----------------------------------------------------------------------------*)
