...
begin
  ...
  begin
    if doit('Bitte beim Lˆschen beachten:' + #13 +
      ...
      + 'Beim Lˆschen eines Folge-Buchungssatzes, wird auch der initiale Buchungssatz gelˆscht!' +
...
begin
  ...
  try
    ...
    begin
      sResult.LoadFromFile(MyProgramPath + cHBCIPath + KontoNummer + '\' + sDir[n]);
      i := sResult.IndexOf('1');
      if i <> -1 then
      begin
    ...
    sCompleteLog.savetofile(DiagnosePath + 'HBCI-Complete-' + KontoNummer + '.txt');
...
begin
  ...
  if doit('Wurde diese Sammellastschrift' + 'nicht erfolgreich durchgef¸hrt?' + #13 +
