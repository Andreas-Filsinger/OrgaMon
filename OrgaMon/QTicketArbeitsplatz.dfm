object FormQTicketArbeitsplatz: TFormQTicketArbeitsplatz
  Left = 125
  Top = 146
  Caption = 'Ticket Arbeitsplatz'
  ClientHeight = 510
  ClientWidth = 861
  Color = clBtnFace
  ...
  object Label1: TLabel
    ...
    Width = 232
    Height = 18
    Caption = 'OrgaMon Ticket Arbeitsplatz'
    Font.Charset = ANSI_CHARSET
    Font.Color = clWindowText
    Font.Height = -15
    Font.Name = 'Verdana'
  ...
  object IB_Query1: TIB_Query
    ...
    OrderingItems.Strings = (
      'Art=ART;ART DESC'
      'VORLAGE=VORLAGE;VORLAGE DESC'
      'ABLAUF=ABLAUF;ABLAUF DESC'
      'OK=AUSGANG;AUSGANG DESC'
      'MOMENT=MOMENT;MOMENT DESC'
      'RID=RID;RID DESC'
      'NUMMER=NUMMER;NUMMER DESC'
      'RECHNER_R=RECHNER_R;RECHNER_R DESC'
      'PERSON_R=PERSON_R;PERSON_R DESC'
      'BEARBEITER_R=BEARBEITER_R;BEARBEITER_R DESC'
