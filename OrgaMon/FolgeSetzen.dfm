object FormFolgeSetzen: TFormFolgeSetzen
  Left = 106
  Top = 140
  Caption = 'Buchungsfolge'
  ClientHeight = 332
  ClientWidth = 844
  Color = clBtnFace
  ...
  object Label1: TLabel
    ...
    Width = 491
    Height = 29
    Caption = 'OrgaMon'#8482'  Buchungsfolge festlegen'
    Font.Charset = ANSI_CHARSET
    Font.Color = clWindowText
    Font.Height = -24
    Font.Name = 'Verdana'
  ...
  object IB_Query1: TIB_Query
    ...
    SQL.Strings = (
      ...
      ' AUSGABEART X'
      'on '
      ' B.AUSGABEART_R=X.RID'
      'where'
      ' (B.MENGE_ERWARTET>0) '
      '/* --- DO NOT REMOVE THIS INSERT POINT */'
      'order BY'
      ' B.FOLGE, B.ZUSAGE')
    ColorScheme = True
    Left = 136
